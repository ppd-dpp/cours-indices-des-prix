...
c(
  ...
  Arithmétique = weighted.mean(relatives, weights),
  Géométrique = geomean(relatives, weights)
)
```
...
c(
  ...
  `Géométrique Laspeyres` = geomean(relatives, share0),
  `Géométrique Paasche` = geomean(relatives, share1),
